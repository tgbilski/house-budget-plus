...
const MarketplacePromo = () => (
  <section className="py-6 md:py-8 lg:py-12 px-3 md:px-4 mx-2 md:mx-4 my-6 md:my-8 rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 shadow-xl border-2 border-gray-700 relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto relative z-10">
      {/* Promotional Banner */}
      <div className="bg-gradient-to-r from-primary/90 to-primary rounded-xl p-4 md:p-6 mb-6 md:mb-8 border border-primary/20 text-center">
        ...
        <Link to="/marketplace">
          <Button 
            size="default"
            className="bg-white text-primary hover:bg-white/90 font-semibold w-full sm:w-auto shadow-lg"
          >
