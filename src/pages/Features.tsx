          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {calculators.map((calc) => (
              <Link key={calc.title} to={calc.href} className="block group">
                <Card className="h-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,0.8)] hover:-translate-x-1 hover:-translate-y-1 border-4 border-black bg-card">
